...
public class BorderRightTranslatorTest extends BorderTranslatorTests {
    private final BorderRightTranslator translator = new BorderRightTranslator();
    ...
    private void testBottomBorder(float size, CollapsedBorderValue right, BorderStyle expected) {
        BorderPropertySet propertySet = new BorderPropertySet(NONE_BORDER, right, NONE_BORDER, NONE_BORDER);
        propertySet.setRight(size);
        ...
        assertEquals(expected, key.getBorderRight());
    }
}